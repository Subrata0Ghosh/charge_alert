...
android {
    namespace = "com.technorchid.charge_alert"
    ...
    defaultConfig {
        ...
        applicationId = "com.technorchid.charge_alert"
    ...
    buildTypes {
        release {
            val hasKeystore = keystorePropertiesFile.exists() &&
                keystoreProperties.getProperty("storeFile")?.let { project.file(it).exists() } == true
